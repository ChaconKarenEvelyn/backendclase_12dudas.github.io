...
<div class="card mb-3" id="card" style="max-width: 540px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="public7/imagenes/tea-5326194_1280.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
  ...
  <button type="button" name="boton_agregar" class="btn btn-primary">AGREGAR PRODUCTO</button>
  </div>
  <div class="d-grid gap-2 d-md-flex justify-content-md-end">
  <a href="./proyecto.php" button class="btn btn-outline-primary me-md-2" type="button" disabled>CANCELAR</a>
  </div>
</form>
