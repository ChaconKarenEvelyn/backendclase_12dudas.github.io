    ...
    <table class="table">
      <thead>
        <tr>
          ...
          <th scope="col" id="inicio">CANTIDAD</th>
    ...
    <?php
      ...
      while($unafila = mysqli_fetch_assoc($resultado)){
        echo "<tr>";
          ...
          <a href='./editar_producto.php' class='edit' title='Edit' data-toggle='tooltip'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil' viewBox='0 0 16 16'>
